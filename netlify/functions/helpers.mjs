// netlify/functions/helpers.mjs
import { v2 as cloudinary } from "cloudinary";
import dayjs from "dayjs";

// Configure Cloudinary Admin SDK from Netlify env vars (already set in Site → Settings → Env)
cloudinary.config({
...
// sanity print shows in Netlify function logs once per cold start
